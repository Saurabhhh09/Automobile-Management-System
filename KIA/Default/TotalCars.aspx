<%@ Page Title="" Language="C#" MasterPageFile="~/Default/defaultMaster.Master" AutoEventWireup="true" CodeBehind="TotalCars.aspx.cs" Inherits="KIA.Default.WebForm5" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row my-3">
        ...
        <asp:DataList ID="DL_TotalCars" runat="server" OnItemCommand="DL_TotalCars_ItemCommand">
